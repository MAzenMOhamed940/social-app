            ...
            {userData && (
              <>
                ...
                <li>
                  <NavLink
                    to="/profilePage"
                    className="block me-40 py-2 px-3 text-main-color rounded-2xl bg-[#E8F5E9] hover:bg-green-600 hover:text-white transition-colors duration-300  md:text-fg-brand"
                    aria-current="page"
                  >
                    My Profile
                  </NavLink>
